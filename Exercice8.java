...
public class Exercice8 {
	...
	public static void main(String[] args) {
		...
		int mineurs = 0;// une variable pour stoquer les personnes de moins de 20 ans.
		for (int i = 0; i < 20; i++) {// une boucle qui se lance 20 fois.
			...
			if ((age < 20)&&(age > 0)) {//si la personne à moins de 20 ans et plus de 0 ans,
				mineurs++;				//je la stoque dans ma variable mineur.
		...
		System.out.println("il y à " + mineurs + " personnes de moins de vingt ans");
		sc.close();
	}
}
